...
if (!this.texPlayer.image.loaded) {
    this.texPlayer.image.onload = function() {
        gl.bindTexture( gl.TEXTURE_2D, this.texPlayer );
        gl.texImage2D( gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, this.texPlayer.image );
        gl.texParameteri( gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST );
        gl.texParameteri( gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST );
        this.texPlayer.image.loaded = true; 
    };
	...
	terrainTexture.image = new Image();
            terrainTexture.image.crossOrigin = "anonymous";
