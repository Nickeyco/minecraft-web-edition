...
¿wanna try it? go here -> https://nickeyco.github.io/minecraft-web-edition/  (also for some reason you need to reload the page from the url space in singleplayer)
